<img align="right" hspace="20" src="https://img.shields.io/badge/CCF-v1.0.0-green.svg?style=flat-square"/>

# Caixa Comportamental de Firmino 

:octocat: Repositório dedicado a tarefa 2 (CAIXA COMPORTAMENTAL DE FIRMINO) da disciplina "Fundamentos de Programação e Engenharia de Software - PES-001(2019.2)" do Programa de Pós-Graduação em Neuroengenharia do Instituto Internacional de Neurociências Edmond e Lily Safra (IIN-ELS).
...
## Primeiros Passos: 
A seguir, será fornecido algumas informações e orientações básicas a respeito da caixa comportamental de Firmino (CCF). Para maiores informações e os recursos por ele fornecidos, visite a [Wiki] do projeto.

## 1. Recursos necessários

**IMPORTANTE:** Para contribuir com a **CCF**, algumas ações devem ser realizadas para que tudo funcione corretamente. Primeiro certifique-se que você possuí instalados: 
...
## 2. Realizando "Fork" do repositório da Caixa Comportamental de Firmino:

   1. Logar na sua conta do Github;
   2. Acessar o [repositório CCF]; 
...
O VSCode é totalmente integrado com o Git e torna a ação extremamente simples, se você tá começando a tralhar com controle de versão agora, essa é uma boa opção:
  ...
  3. Será solicitado a url do repositório da CCF; 
  4. Digite: `https://github.com/iinels-pes-001/caixa-comportamental-firmino.git` e tecle enter;
...
Caso deseje realizar a ação utilizando um terminal:
  ...
  3. Execute o comando `git clone https://github.com/iinels-pes-001/caixa-comportamental-firmino.git`; 
  ...
  7. Basta abrir o diretório caixa-comportamental-firmino criado com sua IDE favorita;

## 4. Executando o projeto

Para executar o módulo via terminal: 
1. Acesse o diretório do arquivo que deseja executar (Ex: ... `cd git/`); 
...
Para maiores informações sobre a **CCF** e os recursos por ele fornecidos, visite a [Wiki] do projeto.
...
[repositório CCF]: https://github.com/iinels-pes-001/caixa-comportamental-firmino
[url CCF]: https://github.com/iinels-pes-001/caixa-comportamental-firmino.git
[Wiki]: https://github.com/iinels-pes-001/caixa-comportamental-firmino/wiki
...
[Quadro kanban do projeto]: https://github.com/iinels-pes-001/caixa-comportamental-firmino/projects/1
[Issues do projeto]: https://github.com/iinels-pes-001/caixa-comportamental-firmino/issues
